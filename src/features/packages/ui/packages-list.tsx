...
export function PackagesList({ packages }: { packages: PackageRecord[] }) {
  ...
  const refreshAfterSuccess = () => { setCreating(false); setEditing(null); router.refresh(); };
  return <>
