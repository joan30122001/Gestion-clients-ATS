...
export function ClientsList({ clients, packages, initialStatus = "all" }: { clients: ClientListItem[]; packages: PackageRecord[]; initialStatus?: string }) {
  ...
  const refreshAfterSuccess = () => { setOpen(false); setEditing(null); router.refresh(); };
